...
export const profileSchema = z
  .object({
    ...
    youtubeUrl: z.string().trim().max(200, "200 characters max").url("Enter a valid URL").optional(),
    twitchUrl: z.string().trim().max(200, "200 characters max").url("Enter a valid URL").optional(),
    statlockerUrl: z.string().trim().max(200, "200 characters max").url("Enter a valid URL").optional(),
    xUrl: z.string().trim().max(200, "200 characters max").url("Enter a valid URL").optional(),
    instagramUrl: z.string().trim().max(200, "200 characters max").url("Enter a valid URL").optional(),
